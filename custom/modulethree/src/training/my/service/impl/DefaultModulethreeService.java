...
public class DefaultModulethreeService implements ModulethreeService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultModulethreeService.class);
	...
	{
		return DefaultModulethreeService.class.getResourceAsStream("/modulethree/sap-hybris-platform.png");
	}
