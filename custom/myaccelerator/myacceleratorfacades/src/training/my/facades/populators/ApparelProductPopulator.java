 ...
 */
package training.my.facades.populators;
...
import training.my.core.model.ApparelProductModel;
import training.my.facades.product.data.GenderData;
...
public class ApparelProductPopulator implements Populator<ProductModel, ProductData>
{
	...
	public void populate(final ProductModel source, final ProductData target) throws ConversionException
	{
		...
		if (baseProduct instanceof ApparelProductModel)
		{
			...
			target.setCustomSize(apparelProductModel.getCustomSize());
			target.setCustomSizeValue(apparelProductModel.getCustomSizeValue());
		}
	}
