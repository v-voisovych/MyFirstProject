 ...
 */
package training.my.v1.controller;

import static training.my.constants.YcommercewebservicesConstants.ENUM_VALUES_SEPARATOR;
...
import training.my.formatters.WsDateFormatter;
import training.my.product.data.ProductDataList;
import training.my.product.data.SuggestionDataList;
import training.my.queues.data.ProductExpressUpdateElementData;
import training.my.queues.data.ProductExpressUpdateElementDataList;
import training.my.queues.impl.ProductExpressUpdateQueue;
import training.my.stock.CommerceStockFacade;
import training.my.util.ws.SearchQueryCodec;
import training.my.validator.PointOfServiceValidator;
...
public class ProductsController extends BaseController
{
	 ...
	 * {@link training.my.populator.HttpRequestReviewDataPopulator} to populate review data
