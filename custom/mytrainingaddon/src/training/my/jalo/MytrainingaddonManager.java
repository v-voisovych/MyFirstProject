...
import training.my.constants.MytrainingaddonConstants;



/**
 * This is the extension manager of the Mytrainingaddon extension.
 */
public class MytrainingaddonManager extends GeneratedMytrainingaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MytrainingaddonManager.class.getName());
	 ...
	 */
	public static MytrainingaddonManager getInstance()
	{
		return (MytrainingaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MytrainingaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MytrainingaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MytrainingaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MytrainingaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MytrainingaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
