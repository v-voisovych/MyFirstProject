...
public class DefaultModulefourService implements ModulefourService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultModulefourService.class);
	...
	{
		return DefaultModulefourService.class.getResourceAsStream("/modulefour/sap-hybris-platform.png");
	}
