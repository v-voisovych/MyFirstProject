 ...
 */
public class UiextensionManager extends GeneratedUiextensionManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(UiextensionManager.class.getName());
	...
	{
		return (UiextensionManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(UiextensionConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public UiextensionManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of UiextensionManager called.");
		}
	}
